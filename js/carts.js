...
$(function () {
    ...
    $('.calBtn').click(function(){
        ...
        $.sendConfirm({
            ...
            msg: 'Are you sure you want to submit the order?',
            button: {
              confirm: 'Confirm',
              cancel: 'Close',
              cancelFirst: true
          ...
          $.sendMsg('Order successfully,have a good meal!', 3000, function() {
    ...
    //Confirm button to remove the product
    $('.dialog-sure').click(function () {
        $order_lists.remove();
        if($order_content.html().trim() == null || $order_content.html().trim().length == 0){
            $order_content.parents('.cartBox').remove();
            $.sendMsg('Empty shopping cart!', 3000, function() {
                console.log('sendMsg closed');
